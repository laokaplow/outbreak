...
#This program makes requests to the website: http://freegeoip.net/ Under CreativeCommons 3.0: http://creativecommons.org/licenses/by/3.0/legalcode
...
def get_locations(ip_collection):
  ...
  for ip in ip_collection:
    ...
    node = IpNode(json_object['ip'], json_object['longitude'], json_object['latitude'], json_object['country_name'], json_object['region_name'], json_object['city'])
